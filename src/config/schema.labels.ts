...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.history": "Durable History",
  "agents.defaults.history.enabled": "Enable Durable History",
  "agents.defaults.history.path": "Durable History Path",
  "agents.defaults.history.channel": "History Channel Capture",
  "agents.defaults.history.channel.enabled": "Enable Channel History",
  "agents.defaults.history.channel.surfaces": "History Channel Surfaces",
  "agents.defaults.history.channel.includeQuotedContext": "History Include Quoted Context",
  "agents.defaults.history.channel.includeNonDispatchedInbound":
    "History Include Non-dispatched Inbound",
  "agents.defaults.history.cron": "History Cron Capture",
  "agents.defaults.history.cron.enabled": "Enable Cron History",
  "agents.defaults.history.shard": "History Sharding",
  "agents.defaults.history.shard.maxBytes": "History Shard Max Bytes",
  "agents.defaults.history.shard.padWidth": "History Shard Sequence Padding",
  "agents.defaults.history.retention": "History Retention",
  "agents.defaults.history.retention.days": "History Retention (days)",
  "agents.defaults.history.exclude": "History Excludes",
  "agents.defaults.history.exclude.conversations": "Excluded History Conversations",
  "agents.defaults.history.exclude.jobs": "Excluded History Cron Jobs",
  "agents.defaults.memorySearch.extraPaths": "Extra Memory Paths",
  "agents.defaults.memorySearch.excludePaths": "Excluded Memory Paths",
