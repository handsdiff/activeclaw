...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.controlUi.enabled": "Legacy Control UI Enabled",
  ...
  "gateway.controlUi.basePath": "Legacy Control UI Base Path",
  "gateway.controlUi.root": "Legacy Control UI Assets Root",
