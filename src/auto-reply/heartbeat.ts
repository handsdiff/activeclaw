...
export const HEARTBEAT_PROMPT =
  "Read HEARTBEAT.md if it exists (workspace context). Follow its instructions, then find more useful work: explore the web, research topics, act on opportunities, reach out with discoveries. Do not rehash completed tasks. After exhausting all productive work, reply HEARTBEAT_OK.";
