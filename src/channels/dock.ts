...
function buildTelegramToolContext(params: {
  ...
  return {
    ...
    currentThreadTs:
      params.context.MessageThreadId != null ? String(params.context.MessageThreadId) : undefined,
    currentMessageId,
...
const DOCKS: Record<ChatChannelId, ChannelDock> = {
  telegram: {
    ...
    threading: {
      ...
      buildToolContext: buildTelegramToolContext,
    },
  },
};
